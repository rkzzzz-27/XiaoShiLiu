...
const columns = [
  ...
  { key: 'user_id', label: '碎锦号', type: 'user-link', sortable: false, maxLength: 15 },
...
const userFormFields = [
  { key: 'user_id', label: '碎锦号', type: 'text', required: true, placeholder: '请输入碎锦号', maxlength: 15 },
...
const searchFields = [
  { key: 'user_id', label: '碎锦号', placeholder: '搜索碎锦号' },
